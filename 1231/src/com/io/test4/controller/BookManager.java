...
public class BookManager {
	...
	public void fileSave() {
		...
		b[0] = new Book("아기돼지 삼형제", "모름", 12_000, cal, 10.0);
		b[1] = new Book("겨울왕국", "디즈니", 20_000, cal, 5.0);
		b[2] = new Book("부자아빠", "기요사키 로버트", 15_800, cal, 15.0);
		b[3] = new Book("부의 추월차선", "엠제이 드마코", 13_500, cal, 8.0);
		b[4] = new Book("집에있던 낡은책", "몰라몰라", 1_000, cal, 50.0);
